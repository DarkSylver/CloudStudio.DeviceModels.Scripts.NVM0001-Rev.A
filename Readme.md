...
# Configuration Script – NVM0001 - Rev. A

This **Configuration** script is designed for the **NVM0001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – NVM0001 Rev. A

Este script de **Configuration** está diseñado para el modelo **NVM0001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
